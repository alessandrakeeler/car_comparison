...
```
{
  "id": "0911bb18-a0f9-4a80-b3c2-0829d9fe63a9",
  "status": "in progress",
  "feature1": "smog_rating",
  "feature2": "co2_rating",
  "comparison_factor": "vehicle_class"
}
```

- `/download/<job_uuid> `   downloads the image generated by the worker     

Once a job is completed by the graphing worker, run curl <API_IP>:5009/download/<JOB_ID>>output.png
